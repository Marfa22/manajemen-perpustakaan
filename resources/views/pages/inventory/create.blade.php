...
@section('header')
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Tambah Inventaris Barang Kantor</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Beranda</a></li>
          <li class="breadcrumb-item active">Barang Kantor</li>
        </ol>
      </div>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
      <div class="col">
        <form action="{{ request()->getBaseUrl() }}/inventory/store" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="card crud-form-card">
            <div class="card-header">
              <h3>Form Inventaris Kantor</h3>
              <p>Lengkapi data barang kantor agar mudah dilacak.</p>
            </div>
            <div class="card-body">
              <div class="crud-form-grid">
                <div class="form-group">
                  <label for="nama" class="form-label">Nama</label>
                  <input type="text" name="nama" id="nama" autocomplete="off" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama') }}" placeholder="Contoh: Laptop Dell">
                  @error('nama')
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="kode_barang" id="kode_barang" autocomplete="off" class="form-control @error('kode_barang') is-invalid @enderror" value="{{ old('kode_barang') }}" placeholder="Contoh: INV-001">
                  @error('kode_barang')
                    <span class="invalid-feedback d-block">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="serial_number" id="serial_number" autocomplete="off" class="form-control @error('serial_number') is-invalid @enderror" value="{{ old('serial_number') }}" placeholder="Contoh: SN-ABC-001">
                  @error('serial_number')
                    <span class="invalid-feedback d-block">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="penanggung_jawab" id="penanggung_jawab" autocomplete="off" class="form-control @error('penanggung_jawab') is-invalid @enderror" value="{{ old('penanggung_jawab') }}" placeholder="Contoh: Budi Santoso">
                ...
                <div class="form-group full-width">
                  ...
                  <div class="hier-picker" id="hierPickerCreate">
                ...
                <div class="form-group full-width">
                  ...
                  <input type="hidden" name="sub_location_id" id="sub_location_id" value="{{ old('sub_location_id') }}">

                  <div class="hier-picker" id="locationPickerCreate">
                ...
                <div class="form-group full-width">
                  ...
                  <textarea name="deskripsi" id="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" placeholder="Tulis deskripsi per poin (satu baris satu poin)">{{ old('deskripsi') }}</textarea>
                ...
                <div class="form-group full-width">
                  ...
                  <div class="custom-file">
                    ...
                    >
                    <label class="custom-file-label" for="supporting_file">Pilih file pendukung</label>
                  </div>
...
@push('scripts')
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      var pickerRoot = document.getElementById('hierPickerCreate');
      ...
      var locationPickerRoot = document.getElementById('locationPickerCreate');
